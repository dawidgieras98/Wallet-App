...
const categorySelect = document.querySelector('#categoryOne')
...
// Nowy task, dodawanie klasy, nadanie atrybutu
...
const createNewTransaction = () => {
    ...
    <p class="transaction-amount">${amountInput.value}$ <button class="delete" onclick="deleteTransatcion(${ID})"><i class="fas fa-times"></i></button>
    </p>`
    

    // nadawanie klasy dla poszczególnych transakcji czy expense czy income
...
// dołożenie konkretnej ikony  poprzez sprawdzanie wybranej kategorii w popupie
...
const selectCategory = () => {
    selectedCategory = categorySelect.options[categorySelect.selectedIndex].textContent
...
// usuwanie elementu (transakcji) z tablicy
...
lightTheme.addEventListener('click', changeStyleToLight)
darkTheme.addEventListener('click', changeStyleToDark)
